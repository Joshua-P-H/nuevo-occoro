    ...
    <nav class="navbar" :class="{ close: sidebarClosed }">
      ...
      <div class="menu-bar">
        <div class="menu">
          <ul class="menu-links">
            <li class="nav-link">
              <Link href="/paneles" class="menu-link">
            ...
            <li class="nav-link">
              <Link href="/misionvision" class="menu-link">
                <i className="bx bx-line-chart icon"></i>
                <span class="text nav-text">Misión y Visión</span>
              </Link>
            </li>
            <li class="nav-link">
              <Link href="/carrousel" class="menu-link">
                <i className="bx bx-slider-alt icon"></i>
                <span class="text nav-text">Carrousel</span>
              </Link>
            </li>
            <li class="nav-link">
              <Link href="/alcalde" class="menu-link">
                <i className="bx bxs-user icon"></i>
                <span class="text nav-text">Alcalde</span>
              </Link>
            </li>
            <li class="nav-link">
              <Link href="/logos" class="menu-link">
                <i className="bx bx-images icon"></i>
                <span class="text nav-text">Logos</span>
              </Link>
            </li>
            <li class="nav-link">
              <Link href="/footers" class="menu-link">
                <i className="bx bx-code-alt icon"></i>
                <span class="text nav-text">Footer</span>
              </Link>
            </li>
          </ul>
        </div>
        <div class="bottom-content">
          <li class="nav-link">
            <form @submit.prevent="logout">
              <DropdownLink as="button" class="salir">
                Cerrar sesión
              </DropdownLink>
            </form>
          </li>
...
//import 'boxicons';
const occoro = "/imagenes/occoro.jpeg";
